            ...
            <div class="box container_fluid">
                ...
                <div class="box_right">
                    <div class="box_right_sm">
                        ...
                        <form action="index2.php?act=dangki" method="post">
                            <div class="mb-3 list_input">
                                <label for="exampleInputPassword1" class="form-label">Họ và tên</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="hoten">
                            </div>
                            <div class="mb-3 list_input">
                            ...
                            <div class="mb-3 list_input">
                                <input type="submit" class="btn btn-primary form-control" name="dangki" value="Đăng ký">
                            </div>
                            <div class="thongbao">
                                <?php
                        ...
                        <div class="box_right-social">
                            ...
                            <div class="notice">
                                <p>Bạn đã có tài khoản? <a href="index2.php?act=dangnhap" class="a-blue">Đăng nhập</a></p>
                            </div>
                        </div>
                    </div>
                </div>
