<main>
                    ...
                    echo '
                            <div class="column-product">
                                ...
                                <div class="detail-product">
                                    ...
                                    <div class="price-status-product">
                                        <!-- Giá sản phẩm -->
                                        <div class="price-product"><span>' . $format_tien3 . 'đ</span></div>
                                        <!-- Giá sản phẩm -->
                                        <div class="status-product"><span><i class="fas fa-check"></i> Còn hàng</span></div>
                                    </div>
                                </div>
                                <div class="add-to-cart">
                                        <!-- Thêm vào giỏ hàng -->
                                    <button><a href="index.php?act=addtocart&id=' . $sp3['ma_san_pham'] . '"><i class="fas fa-shopping-cart"></i> Thêm vào giỏ hàng</a></button>
                                        <!-- Thêm vào giỏ hàng -->
                                </div>
                            </div>
                        ';
    ...
    <div class="show-product">
        <h2><i class="fas fa-microchip"></i> Linh kiện máy tính</h2>
        <div id="wapper">
            <div class="row row-product filtering">
                <?php
