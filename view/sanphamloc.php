<main>
    ...
    <div class="show-product">
        <h2><i class="fas fa-filter"></i> Kết quả lọc: <?php echo number_format($from, 0, '', '.') ."-".number_format($to, 0, '', '.') ?></h2>
        <div class="row row-product row-product-5">
            <?php
            foreach ($load_sp_gia as $sp) {
                            ...
                            <div class="column-product">
                                ...
                                <div class="detail-product">
                                    ...
                                    <div class="price-status-product">
                                        <!-- Giá sản phẩm -->
                                        <div class="price-product"><span>' . $format_tien . 'đ</span></div>
                                        <!-- Giá sản phẩm -->
